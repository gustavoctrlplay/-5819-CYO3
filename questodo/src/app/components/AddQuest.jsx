  ...
  return (
    <div className='w-full'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-3 w-full'>
        ...
        />
        <select value={priority} className='p-2 rounded border' onChange={(e) =>{ setPriority(e.target.value); console.log(priority)}} name="" id="">
        ...
        <button type='submit' className='bg-rose-500 p-2 rounded-2xl text-white'>
          Adicionar
        </button>
      </form>
    </div>
